...
import imgTianwen from "figma:asset/ea035d335997adce2e5f882a778a0e9ab74e1c00.png";
  ...
  return (
    <div className="bg-white relative size-full" data-name="kexue">
      <div className="absolute h-[383px] left-[129px] top-[1206px] w-[681px]" data-name="yaogan">
        <div className="absolute h-[383px] left-0 top-[533px] w-[681px]" data-name="xihe">
      ...
      <div className="absolute h-[383px] left-[129px] top-[668px] w-[681px]" data-name="qixiang">
        <div className="absolute h-[383px] left-0 top-0 w-[681px]">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRectangle3} />
        </div>
      </div>
      <div className="absolute h-[389px] left-[119px] top-[180px] w-[691px]" data-name="tianwen">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgTianwen} />
      </div>
    </div>
  );
}