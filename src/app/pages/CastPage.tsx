...
import { X, Maximize2, Minimize2, ChevronLeft, ChevronRight, Monitor } from 'lucide-react';
...
export default function CastPage() {
  ...
  return (
    ...
    >
      {/* 背景模糊层 */}
      <div className="absolute inset-0 backdrop-blur-md" onClick={isFullscreen ? undefined : handleClose} />
        ...
        {isFullscreen ? (
          ...
          >
            ...
            >
              <p>
                {language === 'zh' 
                  ? '💡 快捷键：F - 全屏 | ← → - 切页 | Esc - 关闭 | 拖动边缘调整大小'
                  : '💡 Shortcuts: F - Fullscreen | ← → - Switch Pages | Esc - Close | Drag edges to resize'
                }
              </p>
            </motion.div>
          </motion.div>
