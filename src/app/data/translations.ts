export const translations = {
  ...
  en: {
    nav: {
      constellation: 'Constellation Introduction',
    ...
    home: {
      hero: {
        title: 'A Thousand-Satellite-Scale Space Computing Infrastructure Co-built with Global Partners',
        subtitle: 'Send Artificial Intelligence into Space',
        cta: 'Start Now',
        skip: 'Skip',
      },
    },
    constellation: {
      ...
      screen2: {
        title: 'Defining a New Category of Satellite: Computing Satellite',
      },
      screen3: {
        title1: 'Computing in Space',
        desc1: 'Deploy high-computing-power computing units, routers, and small high-speed inter-satellite communication machines onto satellites, transforming "space sensing, ground computing" into "space sensing, space computing".',
        title2: 'Networking in Space',
        desc2: 'Based on the space-based distributed operating system and inter-satellite networking technology, link multiple space computing nodes into a network, achieving "inter-satellite interconnection" and forming "space cloud computing" capability.',
        title3: 'Models in Space',
        desc3: 'Is to deploy ground models into space, achieving autonomous sensing of on-orbit information and data and autonomous planning of computing tasks.',
      },
      screen4: {
        title: 'Construction Goal',
        subtitle: '1000 satellite scale, 1 EOPS computing power',
      },
      screen5: {
        ...
        phase1: {
          ...
          desc: 'Construct the "First Launch Mission" consisting of 12 computing satellites, complete key technology verification including P-level computing power in space, stable laser link establishment, inter-satellite networking, space-based models, etc.',
        },
        phase2: {
          year: '2027',
          title: 'Scenario Verification Phase: Over a Hundred Computing Satellites',
          desc: 'Conduct demonstration verification for typical scenarios such as remote sensing, astronomy, navigation, and communication, co-build typical demonstration systems with partners, forming a computing constellation with a scale of over a hundred computing satellites.',
        },
        phase3: {
          year: '2032',
          title: 'Large-Scale Networking Phase: Thousand-Satellite-Scale Computing Constellation',
          desc: 'Provide basic services such as protocols, tools, computing power, and algorithms for the industry, build an open technology innovation platform, construct a space computing cooperation ecosystem, and complete the thousand-satellite-scale computing constellation.',
        },
      },
      screen6: {
        ...
        cards: [
          {
            ...
            desc: 'Dual-satellite collaborative detection, achieving in-orbit real-time detection, authentication, and classification of Gamma-Ray Bursts.',
            partners: 'Cooperating Units: Guangxi University, National Astronomical Observatories',
          },
          {
            title: 'Space-based Meteorological Model',
            desc: 'In-orbit generation of weather forecasts, significantly improving the timeliness and accuracy of weather forecasting.',
            partners: 'Cooperating Units: Fudan University, Xuntian Qianhe, Aerospace Eighth Academy',
          },
          {
            ...
            partners: 'Cooperating Units: Beijing Normal University, The University of Hong Kong, Aerospace System Institute',
          },
          {
            title: 'Xihe-2 Satellite',
            desc: 'Provides spaceborne computing power for the Xihe-2 satellite, supporting in-orbit real-time processing of solar observation data.',
            partners: 'Cooperating Units: Nanjing University, Aerospace Eighth Academy, High-Resolution Earth Observation Center',
          },
        ],
      },
      screen7: {
        ...
        card1: {
          ...
          desc: 'The world\'s first international competition focusing on "on-orbit intelligent computing". Winning teams will have the opportunity to receive full-process support from Zhejiang Lab for algorithm uploading to satellites and solution implementation.',
        ...
        card2: {
          ...
          desc: 'Plans to launch 1-2 public-benefit scientific experiment satellites annually, openly soliciting space science payloads and space intelligent applications globally, providing open satellite-integration and verification services.',
          organizer: 'Organizers: Zhejiang Lab, Xiong\'an Science Park, Hongqing Technology',
          cta: 'Learn More',
        },
      },
      screen8: {
        title: 'Cooperating Units',
        subtitle: 'Openness, Collaboration, Sharing, and Discovery',
        statLabels: {
          launched: 'Launched',
          deployed: 'Deployed',
      ...
      screen9: {
        title: 'Space Computing Key Technologies',
        subtitle: 'Zhejiang Lab focuses on breakthroughs in space computing software and hardware technologies, forming a series of key achievements.',
        achievements: [
          {
            title: '"Zhejiang Zhijia" Spaceborne Intelligent Computer',
            desc: 'Adopts a super-heterogeneous architecture design, integrates a lightweight and highly reliable spaceborne operating system, and a high-throughput inference engine, responsible for on-orbit processing, storage, and forwarding of massive satellite data.',
            highlight: 'Computing Power: 1 POPS ~ 10 POPS',
          },
          {
            title: '"Zhejiang Zhiguang" Inter-satellite Laser Communication Machine',
            desc: 'A communication transmission device using laser beams as the carrier, meeting the needs of massive, high-speed, instant, and secure space-based data transmission. It can quickly establish links and maintain them stably, supporting high-rate, high-bandwidth constellation networking.',
            highlight: 'Communication Rate: 10 Gbps ~ 200 Gbps',
          },
          {
            title: '"Zhejiang Zhiqiao" Spaceborne High-Speed Router',
            desc: 'The unified interconnection hub for inter-satellite, satellite-ground, and intra-satellite communication, with high-rate, low-latency, high-reliability transmission capabilities, supporting multi-rate, multi-channel, multi-layer Ethernet switching.',
            highlight: 'Unidirectional Switching Capacity: 440 G ~ 1 T',
          },
          {
            title: 'Zhejiang Space-based Distributed Operating System',
            desc: 'Achieves unified management of constellation satellite networking and computing resources, supports flexible deployment and on-orbit real-time updates of space-based models or applications.',
            highlight: 'Computing Constellation Resource Manager',
          },
          {
            title: 'Embodied Intelligent Satellite Model',
            desc: 'Deeply integrates artificial intelligence technology with traditional satellites, enabling satellites to have resource perception, task planning, intelligent decision-making, and autonomous execution capabilities.',
            highlight: 'Computing Constellation Intelligent Brain',
          },
        ],
      },
    },
    services: {
      screen1: {
        title: 'Send Artificial Intelligence into Space',
        subtitle: 'Supports the entire process from model training, debugging, ground verification to deployment',
        highlight: 'Future scientists, start your journey here',
        cta: 'Start Now',
        stats: {
    ...
    about: {
      screen1: {
        title: 'Research Center for Space Computing System',
        desc: 'The Research Center for Space Computing System takes building the "Three-Body Computing Constellation" as its mission. Adopting the approach of "openness, collaboration, sharing, and discovery", it jointly builds a thousand-satellite-scale computing constellation with global partners, creates an open and shared space computing system, constructs space-based intelligent computing infrastructure, provides space-based computing services for satellites in communication, navigation, remote sensing, and space science, and provides important support for national major strategic tasks and global open scientific and technological cooperation.',
      },
      screen2: {
        title: 'Milestones',
        events: [
      ...
      screen4: {
        ...
        options: [
          ...
          'Become a Space Intelligent Application Partner',
        ],
        contact: {
          phone: 'Phone: 13975139466',
          email: 'Email: guogang@zhejianglab.org',
          address: 'Address: No. 2880 Wenyi West Road, Yuhang District, Hangzhou City',
        },
      },
    },
    footer: {
      title: 'Three-Body Computing Constellation',
      subtitle: 'A Thousand-Satellite-Scale Space Computing Infrastructure Co-built with Global Partners',
      viewMore: 'View More',
      links: {
        constellation: 'Constellation Introduction',
        services: 'Open Services',
